...
const MOCK_BUYERS = [
  { id:  1, name: 'AutoBidder Inc.',       city: 'Mumbai',        status: 'Active',    score: 88, emd: 250000, lastActive: '2026-05-15', risk: 'Low'      },
  { id:  2, name: 'FastWheels Pvt. Ltd.',  city: 'Delhi',         status: 'Active',    score: 74, emd: 125000, lastActive: '2026-05-14', risk: 'Medium'   },
  { id:  3, name: 'Metro Motors',          city: 'Bangalore',     status: 'Watchlist', score: 44, emd: 50000,  lastActive: '2026-05-10', risk: 'High'     },
  { id:  4, name: 'QuickFleet Co.',        city: 'Chennai',       status: 'Suspended', score: 31, emd: 0,      lastActive: '2026-04-28', risk: 'Critical' },
  { id:  5, name: 'RoadReady Ltd.',        city: 'Hyderabad',     status: 'Active',    score: 91, emd: 400000, lastActive: '2026-05-15', risk: 'Low'      },
  { id:  6, name: 'DriveDirect Auctions',  city: 'Pune',          status: 'Active',    score: 83, emd: 175000, lastActive: '2026-05-13', risk: 'Low'      },
  { id:  7, name: 'Apex Auto Group',       city: 'Kolkata',       status: 'Watchlist', score: 38, emd: 25000,  lastActive: '2026-05-08', risk: 'Critical' },
  { id:  8, name: 'Sunrise Dealers',       city: 'Ahmedabad',     status: 'Active',    score: 62, emd: 90000,  lastActive: '2026-05-12', risk: 'Medium'   },
  { id:  9, name: 'NorthStar Rentals',     city: 'Jaipur',        status: 'Active',    score: 55, emd: 70000,  lastActive: '2026-05-11', risk: 'Medium'   },
  { id: 10, name: 'BidKing Motors',        city: 'Surat',         status: 'Active',    score: 79, emd: 160000, lastActive: '2026-05-15', risk: 'Low'      },
  { id: 11, name: 'CarNation Pvt.',        city: 'Lucknow',       status: 'Inactive',  score: 48, emd: 30000,  lastActive: '2026-04-20', risk: 'High'     },
  { id: 12, name: 'FleetMaster India',     city: 'Nagpur',        status: 'Active',    score: 86, emd: 300000, lastActive: '2026-05-14', risk: 'Low'      },
  { id: 13, name: 'Velocity Autos',        city: 'Indore',        status: 'Watchlist', score: 41, emd: 15000,  lastActive: '2026-05-05', risk: 'High'     },
  { id: 14, name: 'PrimeDrive Corp.',      city: 'Bhopal',        status: 'Active',    score: 93, emd: 500000, lastActive: '2026-05-15', risk: 'Low'      },
  { id: 15, name: 'TruckHub Solutions',    city: 'Patna',         status: 'Active',    score: 67, emd: 80000,  lastActive: '2026-05-13', risk: 'Medium'   },
  { id: 16, name: 'RedRoad Traders',       city: 'Vadodara',      status: 'Suspended', score: 22, emd: 0,      lastActive: '2026-04-05', risk: 'Critical' },
  { id: 17, name: 'EcoFleet Pvt.',         city: 'Bhubaneswar',   status: 'Active',    score: 71, emd: 110000, lastActive: '2026-05-12', risk: 'Medium'   },
  { id: 18, name: 'AutoNation India',      city: 'Chandigarh',    status: 'Active',    score: 82, emd: 200000, lastActive: '2026-05-14', risk: 'Low'      },
  { id: 19, name: 'BudgetBid Cars',        city: 'Coimbatore',    status: 'Watchlist', score: 36, emd: 10000,  lastActive: '2026-05-03', risk: 'Critical' },
  { id: 20, name: 'LuxeDrive Motors',      city: 'Kochi',         status: 'Active',    score: 89, emd: 450000, lastActive: '2026-05-15', risk: 'Low'      },
  { id: 21, name: 'RuralWheels Co.',       city: 'Guwahati',      status: 'Inactive',  score: 52, emd: 40000,  lastActive: '2026-04-15', risk: 'Medium'   },
  { id: 22, name: 'MegaBid Auctions',      city: 'Visakhapatnam', status: 'Active',    score: 76, emd: 140000, lastActive: '2026-05-13', risk: 'Low'      },
  { id: 23, name: 'SwiftCar Traders',      city: 'Rajkot',        status: 'Watchlist', score: 43, emd: 20000,  lastActive: '2026-05-07', risk: 'High'     },
  { id: 24, name: 'TitanFleet Pvt.',       city: 'Mysore',        status: 'Active',    score: 85, emd: 280000, lastActive: '2026-05-14', risk: 'Low'      },
  { id: 25, name: 'AllWheels Inc.',        city: 'Dehradun',      status: 'Active',    score: 58, emd: 65000,  lastActive: '2026-05-11', risk: 'Medium'   },
];
...
const MOCK_FOLLOWUPS = [
  { id:  1, buyerId:  4, buyerName: 'QuickFleet Co.',      type: 'EMD Review',      assignee: 'Priya Sharma',  dueDate: '2026-05-16', priority: 'Urgent', status: 'pending',    notes: 'EMD balance is zero. Urgent review needed before next auction cycle.' },
  { id:  2, buyerId:  7, buyerName: 'Apex Auto Group',     type: 'Schedule Call',   assignee: 'Rajan Mehta',   dueDate: '2026-05-16', priority: 'Urgent', status: 'pending',    notes: 'Account suspended. Discuss reactivation path and outstanding dues.' },
  { id:  3, buyerId: 16, buyerName: 'RedRoad Traders',     type: 'Payment Chase',   assignee: 'Anika Singh',   dueDate: '2026-05-17', priority: 'High',   status: 'pending',    notes: 'Outstanding payment for 2 lots. Legal escalation pending if no response.' },
  { id:  4, buyerId: 19, buyerName: 'BudgetBid Cars',      type: 'Account Review',  assignee: 'Dev Kapoor',    dueDate: '2026-05-18', priority: 'High',   status: 'pending',    notes: 'Critical health score and near-zero EMD. Full account review required.' },
  { id:  5, buyerId:  3, buyerName: 'Metro Motors',        type: 'Follow-up Email', assignee: 'Meera Patel',   dueDate: '2026-05-20', priority: 'Normal', status: 'pending',    notes: 'Send monthly engagement summary and upcoming auction schedule.' },
  { id:  6, buyerId: 13, buyerName: 'Velocity Autos',      type: 'Bid Support',     assignee: 'Priya Sharma',  dueDate: '2026-05-17', priority: 'High',   status: 'inprogress', notes: 'Buyer unable to submit bids on mobile. Portal access issue under investigation.' },
  { id:  7, buyerId: 11, buyerName: 'CarNation Pvt.',      type: 'Credit Check',    assignee: 'Rajan Mehta',   dueDate: '2026-05-17', priority: 'High',   status: 'inprogress', notes: 'Credit limit review for increased bidding capacity. Finance team looped in.' },
  { id:  8, buyerId: 23, buyerName: 'SwiftCar Traders',    type: 'Schedule Call',   assignee: 'Dev Kapoor',    dueDate: '2026-05-18', priority: 'Normal', status: 'inprogress', notes: 'Quarterly check-in on auction experience and upcoming inventory needs.' },
  { id:  9, buyerId:  2, buyerName: 'FastWheels Pvt. Ltd.', type: 'Account Review', assignee: 'Anika Singh',   dueDate: '2026-05-20', priority: 'Normal', status: 'inprogress', notes: 'Routine health review. Score dropped 6 pts this month — investigate cause.' },
  { id: 10, buyerId:  8, buyerName: 'Sunrise Dealers',     type: 'Follow-up Email', assignee: 'Meera Patel',   dueDate: '2026-05-14', priority: 'Normal', status: 'completed',  notes: 'Engagement nudge sent. Buyer responded positively, will bid next week.' },
  { id: 11, buyerId:  9, buyerName: 'NorthStar Rentals',   type: 'EMD Review',      assignee: 'Priya Sharma',  dueDate: '2026-05-13', priority: 'Normal', status: 'completed',  notes: 'EMD topped up to ₹70K after reminder call. Account back in good standing.' },
  { id: 12, buyerId: 15, buyerName: 'TruckHub Solutions',  type: 'Payment Chase',   assignee: 'Rajan Mehta',   dueDate: '2026-05-13', priority: 'High',   status: 'completed',  notes: 'Full payment received for 3 pending lots. Account reconciled.' },
  { id: 13, buyerId: 17, buyerName: 'EcoFleet Pvt.',       type: 'Bid Support',     assignee: 'Dev Kapoor',    dueDate: '2026-05-12', priority: 'Low',    status: 'completed',  notes: 'Mobile bidding interface walkthrough completed. Buyer comfortable now.' },
  { id: 14, buyerId: 21, buyerName: 'RuralWheels Co.',     type: 'Send Alert',      assignee: 'Meera Patel',   dueDate: '2026-05-11', priority: 'Normal', status: 'completed',  notes: 'Inactivity alert sent. No response yet — flagging for next cycle.' },
];
...
const AN_RANGES = {
  '7d': {
    ...
    topBuyers: [
      {name:'PrimeDrive Corp.',  city:'Bhopal',   score:93,bids: 8,delta:+2},
      {name:'RoadReady Ltd.',    city:'Hyderabad',score:91,bids: 7,delta:+1},
      {name:'LuxeDrive Motors',  city:'Kochi',    score:89,bids: 6,delta: 0},
      {name:'FleetMaster India', city:'Nagpur',   score:86,bids: 5,delta:-1},
      {name:'TitanFleet Pvt.',   city:'Mysore',   score:85,bids: 4,delta:+1},
    ],
  },
  '30d': {
    ...
    topBuyers: [
      {name:'PrimeDrive Corp.',  city:'Bhopal',   score:93,bids:28,delta:+3},
      {name:'RoadReady Ltd.',    city:'Hyderabad',score:91,bids:24,delta:+2},
      {name:'LuxeDrive Motors',  city:'Kochi',    score:89,bids:21,delta:+1},
      {name:'AutoBidder Inc.',   city:'Mumbai',   score:88,bids:19,delta:-1},
      {name:'TitanFleet Pvt.',   city:'Mysore',   score:85,bids:16,delta:+2},
    ],
  },
  '90d': {
    ...
    topBuyers: [
      {name:'PrimeDrive Corp.',  city:'Bhopal',   score:93,bids:74,delta:+5},
      {name:'RoadReady Ltd.',    city:'Hyderabad',score:91,bids:68,delta:+3},
      {name:'LuxeDrive Motors',  city:'Kochi',    score:89,bids:61,delta:+2},
      {name:'AutoBidder Inc.',   city:'Mumbai',   score:88,bids:55,delta:-2},
      {name:'BidKing Motors',    city:'Surat',    score:79,bids:48,delta:+4},
    ],
  },
  '6m': {
    ...
    topBuyers: [
      {name:'PrimeDrive Corp.',  city:'Bhopal',   score:93,bids:142,delta: +8},
      {name:'RoadReady Ltd.',    city:'Hyderabad',score:91,bids:128,delta: +6},
      {name:'LuxeDrive Motors',  city:'Kochi',    score:89,bids:118,delta: +4},
      {name:'AutoBidder Inc.',   city:'Mumbai',   score:88,bids:105,delta: -3},
      {name:'BidKing Motors',    city:'Surat',    score:79,bids: 94,delta: +7},
    ],
  },
};
...
const MOCK_NOTIFICATIONS = [
  { id:  1, type: 'payment_issue',    buyerName: 'QuickFleet Co.',       title: 'EMD Balance Zero',         message: 'EMD balance dropped to ₹0. Buyer is ineligible for the next auction cycle.',       time: '2026-05-15T10:30:00', read: false },
  { id:  2, type: 'risky_buyer',      buyerName: 'Apex Auto Group',       title: 'Health Score Critical',    message: 'Health score fell to 38 — lowest this quarter. Suspension risk elevated.',         time: '2026-05-15T09:45:00', read: false },
  { id:  3, type: 'followup_pending', buyerName: 'CarNation Pvt.',        title: 'Follow-up Overdue',        message: 'Credit check task assigned to Rajan Mehta is 2 days overdue.',                    time: '2026-05-15T08:20:00', read: false },
  { id:  4, type: 'approval_issue',   buyerName: 'RedRoad Traders',       title: 'Account Suspended',        message: 'Account auto-suspended after 3 consecutive payment failures. Review needed.',      time: '2026-05-14T16:10:00', read: false },
  { id:  5, type: 'payment_issue',    buyerName: 'BudgetBid Cars',        title: 'Payment Delay',            message: 'Payment for Lot #AU-2241 is 7 days overdue. Escalate if no response today.',     time: '2026-05-14T14:55:00', read: false },
  { id:  6, type: 'risky_buyer',      buyerName: 'Metro Motors',          title: 'Low Bidding Activity',     message: 'No bids placed in 10 days. Engagement risk flagged by system.',                   time: '2026-05-14T11:30:00', read: false },
  { id:  7, type: 'followup_pending', buyerName: 'QuickFleet Co.',        title: 'EMD Review Due Today',     message: 'Task assigned to Priya Sharma is due today with no action recorded yet.',         time: '2026-05-15T07:00:00', read: false },
  { id:  8, type: 'approval_issue',   buyerName: 'SwiftCar Traders',      title: 'Watchlist Escalation',     message: 'Buyer moved to Watchlist after failing compliance screening.',                    time: '2026-05-14T09:00:00', read: false },
  { id:  9, type: 'followup_pending', buyerName: 'FastWheels Pvt. Ltd.',  title: 'Account Review Due',       message: 'Quarterly review scheduled today. Anika Singh assigned — no update yet.',        time: '2026-05-15T08:00:00', read: false },
  { id: 10, type: 'payment_issue',    buyerName: 'Velocity Autos',        title: 'Low EMD Warning',          message: 'EMD balance below minimum threshold (₹15K). Top-up required before bidding.',    time: '2026-05-13T15:40:00', read: true  },
  { id: 11, type: 'risky_buyer',      buyerName: 'RuralWheels Co.',       title: 'Inactivity Alert',         message: 'Account inactive for 30 days. Auto-flag triggered. Consider outreach.',          time: '2026-05-13T10:20:00', read: true  },
  { id: 12, type: 'followup_pending', buyerName: 'RedRoad Traders',       title: 'Payment Chase Overdue',    message: 'Anika Singh\'s follow-up task has been open for 4 days with no resolution.',     time: '2026-05-13T09:00:00', read: true  },
  { id: 13, type: 'approval_issue',   buyerName: 'NorthStar Rentals',     title: 'Document Expired',         message: 'Trade license expired 5 days ago. Re-upload required for continued eligibility.', time: '2026-05-12T14:00:00', read: true  },
  { id: 14, type: 'payment_issue',    buyerName: 'Apex Auto Group',       title: 'Lot Payment Failed',       message: 'Payment for Lot #AU-2198 was declined. Finance team has been notified.',         time: '2026-05-12T11:30:00', read: true  },
  { id: 15, type: 'risky_buyer',      buyerName: 'BudgetBid Cars',        title: 'Score Drop Alert',         message: 'Health score dropped 12 points in 7 days. Full account review recommended.',      time: '2026-05-11T16:45:00', read: true  },
];
